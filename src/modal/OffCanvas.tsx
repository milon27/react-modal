...
export default function OffCanvas({ show, title, hideHeader = false, setShow, onClose = () => { }, position = "left", className = "", bodyClassName = "", children }: iCanvas) {
    ...
    const bottom_show_class = `${common} rm-translate-y-0  rm-right-0 rm-w-full md:rm-w-full rm-mt-[20vh]`
    const bottom_hide_class = `${common} rm-translate-y-full rm-right-0 rm-w-full md:rm-w-full rm-mt-[20vh]`
